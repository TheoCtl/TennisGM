    ...
    def develop_player_weekly(player):
        ...
        for skill_name, current_value in skills.items():
            ...
            if age < 28:
                ...
                chance = PlayerDevelopment.calculate_improvement_chance(age, current_value, pf) / 12.0 #REDUIRE SI PROG PAS ASSEZ VITE
                ...
                if cap['regcap'] >= 5:
                    continue
                chance = PlayerDevelopment.calculate_regression_chance(age, current_value) / 12.0 #REDUIRE SI REG PAS ASSEZ VITE
